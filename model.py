# -*- coding: utf-8 -*-
"""
Created on Fri Jul  5 14:21:49 2024
...
class CNNBlock(nn.Module):  # Inherited from
...
class Yolov1(nn.Module):
    ...
    def _create_conv_layers(self, architecture):
        ...
        return nn.Sequential(*layers)  # here in *layers '*' is used to unpack the items in the list of layers.
    ...
    def _create_fcs(self, split_size, num_boxes, num_classes):
        ...
        return nn.Sequential(nn.Flatten(),
                             ...
                             nn.Dropout(0.5),
                             nn.LeakyReLU(0.1),
                             nn.Linear(496, S * S * (C + B * 5)))  # reshaped to be (S, S, 30), C+B*5 = 30
